  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div className='w-full'>
        ...
        <input onChange={(e) => setName(e.target.value)} value={name} type="text" className="w-full max-w-[50%] px-3 py-2" placeholder='Type here ' required />
      </div>
      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} type="text" className="w-full max-w-[50%] px-3 py-2" placeholder='write content here' required />
      </div>
      ...
      <div className='flex gap-2 mt-2'>
        ...
        <label className='cursor-pointer' htmlFor='bestseller'>Add to Seller</label>
      </div>
