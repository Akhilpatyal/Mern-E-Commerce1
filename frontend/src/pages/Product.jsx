...
fetchProductData();
    ...
    <div className='border-t-1 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className="flex-1">
          ...
          <div className='flex item-center gap-1 mt-2'>
            <img className='w-4 5' src={assets.star_icon} alt="" />
            <img className='w-4 5' src={assets.star_icon} alt="" />
            <img className='w-4 5' src={assets.star_icon} alt="" />
            <img className='w-4 5' src={assets.star_icon} alt="" />
            <img className='w-4 5' src={assets.star_icon} alt="" />
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, possimus incidunt itaque harum eveniet accusantium omnis similique exercitationem fugiat qui.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, possimus incidunt itaque harum eveniet accusantium omnis similique exercitationem fugiat qui.</p>
        </div>
      </div>
  ...
  ): <h1>no products Available</h1>//<div className='opacity-0'> </div>
}
